        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <h3>Welcome to Women's Fashion</h3>
                </div>
            </div>
        </div>
    </section>
...
<table >
    ...
    $sql = "SELECT id, Product_Image, Product_Name,Category,Brand,Price FROM productlist where Category='Women Fashion'" ;	   	
    ...
    if (mysqli_num_rows($result) > 0)
    {
        ...
        while($row = mysqli_fetch_array($result))
        {
            ...
            echo "<h2><span style='font-weight:normal;''>&emsp;&emsp;₹" . $row["Price"]."</span><h2><br>";
            ...
            //echo '&emsp;&emsp;<a href="product-left-sidebar11.php?id='. $row['id']. '"><button class="btn listing-content"> rent now</button></a></td></tr><br><br>"';
           
            
            //echo '<td><a href="delete-order.php?id=' .  $row['id'] .  '"> Cancel</a></td></tr>';
           //<td><a href="update-action.php?userid=<?php echo $row["id"]; 
